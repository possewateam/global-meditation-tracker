...
var deepFind = /* @__PURE__ */ __name((obj, path, keySeparator = ".") => {
  if (!obj) return void 0;
  if (obj[path]) {
...
var getCleanedCode = /* @__PURE__ */ __name((code) => code == null ? void 0 : code.replace("_", "-"), "getCleanedCode");
var consoleLogger = {
  type: "logger",
  log(args) {
...
var deepFindWithDefaults = /* @__PURE__ */ __name((data, defaultData, key, keySeparator = ".", ignoreJSONStructure = true) => {
...
var createNonCachedFormatter = /* @__PURE__ */ __name((fn) => (v, l, o) => fn(getCleanedCode(l), o)(v), "createNonCachedFormatter");
...
//# sourceMappingURL=chunk-4L5BGVYY.js.map
