import {
  keysFromSelector
} from "./chunk-4L5BGVYY.js";
import {
  require_react
} from "./chunk-TQKPMGVS.js";
import {
  __commonJS,
  __name,
  __toESM
...
var warn = /* @__PURE__ */ __name((i18n, code, msg, rest) => {
  var _a, _b, _c, _d;
  const args = [msg, {
    code,
    ...rest || {}
...
var alreadyWarned = {};
var warnOnce = /* @__PURE__ */ __name((i18n, code, msg, rest) => {
  if (isString(msg) && alreadyWarned[msg]) return;
  if (isString(msg)) alreadyWarned[msg] = /* @__PURE__ */ new Date();
  warn(i18n, code, msg, rest);
}, "warnOnce");
var loadedClb = /* @__PURE__ */ __name((i18n, cb) => () => {
...
var loadNamespaces = /* @__PURE__ */ __name((i18n, ns, cb) => {
  i18n.loadNamespaces(ns, loadedClb(i18n, cb));
}, "loadNamespaces");
var loadLanguages = /* @__PURE__ */ __name((i18n, lng, ns, cb) => {
...
var hasLoadedNamespace = /* @__PURE__ */ __name((ns, i18n, options = {}) => {
...
var getDisplayName = /* @__PURE__ */ __name((Component) => Component.displayName || Component.name || (isString(Component) && Component.length > 0 ? Component : "Unknown"), "getDisplayName");
var isString = /* @__PURE__ */ __name((obj) => typeof obj === "string", "isString");
var isObject = /* @__PURE__ */ __name((obj) => typeof obj === "object" && obj !== null, "isObject");
...
var unescapeHtmlEntity = /* @__PURE__ */ __name((m) => htmlEntities[m], "unescapeHtmlEntity");
var unescape = /* @__PURE__ */ __name((text) => text.replace(matchHtmlEntity, unescapeHtmlEntity), "unescape");
...
var setDefaults = /* @__PURE__ */ __name((options = {}) => {
  defaultOptions = {
    ...defaultOptions,
    ...options
  };
}, "setDefaults");
var getDefaults = /* @__PURE__ */ __name(() => defaultOptions, "getDefaults");

// node_modules/react-i18next/dist/es/i18nInstance.js
var i18nInstance;
var setI18n = /* @__PURE__ */ __name((instance) => {
  i18nInstance = instance;
}, "setI18n");
var getI18n = /* @__PURE__ */ __name(() => i18nInstance, "getI18n");

// node_modules/react-i18next/dist/es/TransWithoutContext.js
var hasChildren = /* @__PURE__ */ __name((node, checkLength) => {
  var _a;
...
var getChildren = /* @__PURE__ */ __name((node) => {
  var _a, _b;
  if (!node) return [];
...
var hasValidReactChildren = /* @__PURE__ */ __name((children) => Array.isArray(children) && children.every(import_react.isValidElement), "hasValidReactChildren");
var getAsArray = /* @__PURE__ */ __name((data) => Array.isArray(data) ? data : [data], "getAsArray");
var mergeProps = /* @__PURE__ */ __name((source, target) => {
  const newTarget = {
    ...target
  };
...
var nodesToString = /* @__PURE__ */ __name((children, i18nOptions, i18n, i18nKey) => {
  if (!children) return "";
  let stringNode = "";
...
var escapeLiteralLessThan = /* @__PURE__ */ __name((str, keepArray = [], knownComponentsMap = {}) => {
  if (!str) return str;
  ...
  return result;
}, "escapeLiteralLessThan");
var renderNodes = /* @__PURE__ */ __name((children, knownComponentsMap, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) => {
  if (targetString === "") return [];
  const keepArray = i18nOptions.transKeepBasicHtmlNodesFor || [];
  const emptyChildrenButNeedsHandling = targetString && new RegExp(keepArray.map((keep) => `<${keep}`).join("|")).test(targetString);
  if (!children && !knownComponentsMap && !emptyChildrenButNeedsHandling && !shouldUnescape) return [targetString];
  const data = knownComponentsMap ?? {};
  const getData = /* @__PURE__ */ __name((childs) => {
  ...
  const renderInner = /* @__PURE__ */ __name((child, node, rootReactNode) => {
    var _a;
  ...
  const pushTranslatedJSX = /* @__PURE__ */ __name((child, inner, mem, i2, isVoid) => {
    if (child.dummy) {
  ...
  const mapAST = /* @__PURE__ */ __name((reactNode, astNode, rootReactNode) => {
...
var fixComponentProps = /* @__PURE__ */ __name((component, index, translation) => {
  ...
  __name(Componentized, "Componentized");
  return (0, import_react.createElement)(Componentized, {
    key: componentKey
  });
}, "fixComponentProps");
var generateArrayComponents = /* @__PURE__ */ __name((components, translation) => components.map((c2, index) => fixComponentProps(c2, index, translation)), "generateArrayComponents");
var generateObjectComponents = /* @__PURE__ */ __name((components, translation) => {
  const componentMap = {};
  ...
  return componentMap;
}, "generateObjectComponents");
var generateComponents = /* @__PURE__ */ __name((components, translation, i18n, i18nKey) => {
...
var isComponentsMap = /* @__PURE__ */ __name((object) => {
...
var _ReportNamespaces = class _ReportNamespaces {
  constructor() {
    this.usedNamespaces = {};
  }
...
var ReportNamespaces = _ReportNamespaces;
var composeInitialProps = /* @__PURE__ */ __name((ForComponent) => async (ctx) => {
  var _a;
...
var getInitialProps = /* @__PURE__ */ __name(() => {
  var _a;
  const i18n = getI18n();
...
var _TranslationParserError = class _TranslationParserError extends Error {
...
__name(_TranslationParserError, "TranslationParserError");
var TranslationParserError = _TranslationParserError;
...
var decodeHtmlEntities = /* @__PURE__ */ __name((text) => text.replace(entityPattern, (match) => commonEntities[match]).replace(/&#(\d+);/g, (_, num) => String.fromCharCode(parseInt(num, 10))).replace(/&#x([0-9a-fA-F]+);/g, (_, hex) => String.fromCharCode(parseInt(hex, 16))), "decodeHtmlEntities");

// node_modules/react-i18next/dist/es/IcuTransUtils/tokenizer.js
var tokenize = /* @__PURE__ */ __name((translation) => {
  const tokens = [];
  let position = 0;
  let currentText = "";
...
var renderDeclarationNode = /* @__PURE__ */ __name((declaration, children, childDeclarations) => {
  const {
    type,
    props = {}
  } = declaration;
...
}, "renderDeclarationNode");
var renderTranslation = /* @__PURE__ */ __name((translation, declarations = []) => {
  if (!translation) {
    return [];
  }
  ...
  const getCurrentDeclarations = /* @__PURE__ */ __name(() => {
    var _a;
    if (stack.length === 0) {
      return declarations;
    }
...
__name(IcuTransWithoutContext, "IcuTransWithoutContext");
...
__name(IcuTrans, "IcuTrans");
IcuTrans.displayName = "IcuTrans";

// node_modules/react-i18next/dist/es/useTranslation.js
var import_react7 = __toESM(require_react(), 1);
var import_shim = __toESM(require_shim(), 1);
var notReadyT = /* @__PURE__ */ __name((k, optsOrDefaultValue) => {
...
var dummySubscribe = /* @__PURE__ */ __name(() => () => {
}, "dummySubscribe");
var useTranslation = /* @__PURE__ */ __name((ns, props = {}) => {
  var _a, _b;
  const {
    i18n: i18nFromProps
  } = props;
  ...
  (0, import_react7.useEffect)(() => {
    if (i18n && !ready && !useSuspense) {
      const onLoaded = /* @__PURE__ */ __name(() => setLoadCount((c2) => c2 + 1), "onLoaded");
      if (props.lng) {
  ...
  if (i18n && useSuspense && !ready) {
    throw new Promise((resolve) => {
      const onLoaded = /* @__PURE__ */ __name(() => resolve(), "onLoaded");
      if (props.lng) {
        loadLanguages(i18n, props.lng, namespaces, onLoaded);
      } else {
        loadNamespaces(i18n, namespaces, onLoaded);
...
var withTranslation = /* @__PURE__ */ __name((ns, options = {}) => /* @__PURE__ */ __name(function Extend(WrappedComponent) {
  ...
  const forwardRef = /* @__PURE__ */ __name((props, ref) => (0, import_react8.createElement)(I18nextWithTranslation, Object.assign({}, props, {
    forwardedRef: ref
  })), "forwardRef");
...
var Translation = /* @__PURE__ */ __name(({
  ns,
  children,
  ...options
}) => {
...
var useSSR = /* @__PURE__ */ __name((initialI18nStore, initialLanguage, props = {}) => {
  var _a;
  const {
    i18n: i18nFromProps
  } = props;
...
// node_modules/react-i18next/dist/es/withSSR.js
var withSSR = /* @__PURE__ */ __name(() => /* @__PURE__ */ __name(function Extend(WrappedComponent) {
...
var date = /* @__PURE__ */ __name(() => "", "date");
var time = /* @__PURE__ */ __name(() => "", "time");
var number = /* @__PURE__ */ __name(() => "", "number");
var select = /* @__PURE__ */ __name(() => "", "select");
var plural = /* @__PURE__ */ __name(() => "", "plural");
var selectOrdinal = /* @__PURE__ */ __name(() => "", "selectOrdinal");
export {
  I18nContext,
  I18nextProvider,
  IcuTrans,
