/*
  # Update Cleanup Threshold for Stale Sessions

  1. Changes
    - Update `cleanup_stale_sessions()` function to check for sessions older than 30 seconds instead of 5 minutes
    - This ensures faster cleanup when users close their browsers without stopping meditation
    - Works in conjunction with 10-second heartbeat updates

  2. Notes
    - Sessions without heartbeat for 30+ seconds will be auto-closed
